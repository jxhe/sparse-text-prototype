...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', choices=["synthetic", "yahoo", "yelp", "ptb", "all"],
        default="ptb", help='dataset to use')
    ...
    ptb_id = "1Lh-kDhGtUuQ0inlyVor1ea6eGvVsmeUb"
    ...
    if args.dataset == "synthetic":
        ...
        file_id = [synthetic_id, yahoo_id, yelp_id, ptb_id]
