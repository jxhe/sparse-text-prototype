...
class LanguagePairMapDataset(LanguagePairDataset):
    """A slight addon to LanguagePairDataset that supports
    index mapping
    """
    def __init__(
        self, src, src_sizes, src_dict, index_map=None,
        ...
        super(LanguagePairMapDataset, self).__init__(
