#!/bin/bash
#SBATCH --output=checkpoint/slurm_out/slurm-%A_%a.out
#SBATCH --error=checkpoint/slurm_out/slurm-%A_%a.err
#SBATCH --array=0-0%1
#SBATCH --gres=gpu:2
#SBATCH --mem=30g
#SBATCH --exclude=compute-0-31
#SBATCH -t 0
