...
while getopts ":g:a:p:k:e:l:t:s:r:f:c:m:" arg; do
  case $arg in
    g) GPU="$OPTARG"
    ;;
    a) alpha="$OPTARG"
...
do
    ...
    CUDA_VISIBLE_DEVICES=${GPU} python ${train_script} \
        ...
        --arch ${arch} --task support_prototype \
        ...
        --dropout 0.1 --weight-decay ${weight_decay} \
